...
Both Kaggle_Cleaned_Sets are CSV files with labels [appID, name, release_date, price, supported_languages, developers, publishers, categories, genres, tags, metacriticScore].
